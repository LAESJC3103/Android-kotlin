...
public class ComandaRequest {
    ...
    private List<ComandaArticuloRequest> Listas;

    public ComandaRequest() {
    }

    public ComandaRequest(String COD_MESA, String COD_USU, String COD_ALM, String ALM_MP, String MES_ADJUNTA, List<ComandaArticuloRequest> listas) {
    ...
    public List<ComandaArticuloRequest> getListas() {
        return Listas;
    }

    public void setListas(List<ComandaArticuloRequest> listas) {
        Listas = listas;
    }

    @Override
    public boolean equals(Object obj) {
        return obj!=null && obj instanceof ComandaRequest && ((ComandaRequest)obj).getCOD_MESA() !=null &&((ComandaRequest)obj).getCOD_MESA().equals(this.COD_MESA);
    }
}
