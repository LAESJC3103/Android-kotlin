...
import pacificsoft.pscomandera.Impresion.starBluetooth.PrinterSetting;
...
public class EnumModelCapability {

  public static final int NONE                    = 0;
  public static final int MPOP                    = 1;
  ...
  // V5.3.0
  public static final int SM_L300                 = 20;

  // V5.6.0
  public static final int MC_PRINT2               = 21;
  ...
  private static final SparseArray<ModelInfo> mModelCapabilityMap = new SparseArray<ModelInfo>() {
    {
      put(MC_PRINT2, new ModelInfo(
              ...
              PrinterSetting.PAPER_SIZE_TWO_INCH,     // Default paper size
      ...
      put(MC_PRINT3, new ModelInfo(
              ...
              Emulation.StarPRNT,                             // Emulation
              "",                                             // Default portSettings
              PrinterSetting.PAPER_SIZE_THREE_INCH,   // Default paper size
              true,                                           // canSetDrawerOpenStatus
              true,                                           // canPrintTextReceiptSample
              true,                                           // canPrintUtf8EncodedText
              true,                                           // canPrintRasterReceiptSample
      ...
      put(TSP800II, new ModelInfo(
              ...
              Emulation.StarLine,                             // Emulation
              "",                                             // Default portSettings
              PrinterSetting.PAPER_SIZE_FOUR_INCH,    // Default paper size
              true,                                           // canSetDrawerOpenStatus
              true,                                           // canPrintTextReceiptSample
              true,                                           // canPrintUtf8EncodedText
              true,                                           // canPrintRasterReceiptSample
      ...
      put(SP700, new ModelInfo(
              ...
              "",                                                 // Default portSettings
              PrinterSetting.PAPER_SIZE_DOT_THREE_INCH,   // Default paper size
              true,                                               // canSetDrawerOpenStatus
              true,                                               // canPrintTextReceiptSample
              true,                                               // canPrintUtf8EncodedText
      ...
      put(BSC10, new ModelInfo(
              ...
              PrinterSetting.PAPER_SIZE_ESCPOS_THREE_INCH,    // Default paper size
              true,                                                   // canSetDrawerOpenStatus
              true,                                                   // canPrintTextReceiptSample
              false,                                                  // canPrintUtf8EncodedText
              true,                                                   // canPrintRasterReceiptSample
  ...
  public static ArrayList<ModelInfo> getModelosImpresoras(){

    ArrayList<ModelInfo> lst = new ArrayList<>();

    for (int i = 0; i < mModelCapabilityMap.size(); i++) {
      lst.add(mModelCapabilityMap.valueAt(i));
