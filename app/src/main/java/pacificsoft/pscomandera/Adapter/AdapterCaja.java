...
public class AdapterCaja extends BaseAdapter {

    List<Caja> listaDatos;
    Context context;

    public AdapterCaja(List<Caja> listaDatos, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        dividerRowItem.setVisibility(View.GONE);
